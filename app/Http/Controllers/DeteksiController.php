...
class DeteksiController extends Controller
{
    ...
    public function saveData(Request $request)
    {
        ...
        $tb = tinggibadan::create([
            'pasien_id' => $pasien['id'],
            'tinggi_badan' => $data['tinggi_badan'],
            'status_tinggi' => $data['status_tb'],
        ]);
        $bb = beratbadan::create([
            'pasien_id' => $pasien['id'],
            'berat_badan' => $data['berat_badan'],
            'status_berat' => $data['status_bb'],
        ]);
        $lk = datalingkar::create([
            'pasien_id' => $pasien['id'],
            'lingkar_kepala' => $data['lingkar_kepala'],
            'path_gambar' => $data['path_gambar'],
            'path_gambar_fire' => $data['path_gambar_fire'],
            'status_lingkar' => $data['status_lingkar'],
        ]);
    ...
    public function deteksiLingkar(Request $request)
    {
        ...
        //return redirect()->route('saveLingkar', compact('newReq'))->with('_method','POST');
        return response()->json([
            'data' => [
                'lingkar_kepala' => $hasil,
                'status' => $status,
                'pathGambar' => $data['gambar'],
                'pathGambarFire' => $pathFire
            ]
            ,
            'message' => 'Sukses!'
        ], 200);
